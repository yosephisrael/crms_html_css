        ...
        while($row=mysqli_fetch_array($result)){
            ...
            ?> 
             <tr>
                ...
                <td style="display:flex"><a class="aa"href="viewCriminal.php?cid=<?php echo $cid ?>"><i class="fa-solid fa-eye"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="aa"href="deleteCriminal.php?cid=<?php echo $cid ?>"><i class="fa-solid fa-trash icon"></i></a></td>
