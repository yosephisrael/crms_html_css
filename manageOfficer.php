        ...
        while($row=mysqli_fetch_array($result)){
            ...
            ?> 
             <tr>
                ...
                <td style="display:flex"><a class="aa"href="updateOfficer.php?oid=<?php echo $oid ?>"><i class="fa-solid fa-pen"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="aa"href="deleteOfficer.php?oid=<?php echo $oid ?>"><i class="fa-solid fa-trash icon"></i></a></td>
