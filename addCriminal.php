...
$sql="INSERT INTO criminal(cid,crimetype,crimedate,crimetime,name,moblienum,height,weight,dob,email,city,country,photo) 
VALUES('$cid','$crimetype','$crimedate','$crimetime','$name','$mobilenum','$height','$weight','$dob','$email','$city','$country','$photo')";
          ...
          <div class="second-list">
            <fieldset class="crimefield">
              ...
              <form class="addcriminal" action="<?php $s ?>" method="POST">
                ...
                <input type="date" name="crimedate" style="width: 15%" required />
                <label style="margin-left: 285px">Crime Time:</label>
                <input type="time" name="crimetime" style="width: 15%" required/>
                <br /><br />

            <legend class="l2"><h1>Criminal Details</h1></legend>             
                <label>Criminal Id:</label>
                <input type="text" name="cid" style="width: 15%" required/><br /><br />
                <label>Name:</label>
                <input
                  type="text"
                  name="name"
                ...
                <label>Height:</label>
                <input type="text" name="height" style="width: 15%" required />
