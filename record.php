          ...
          $cid=$row['id'];
            ...
            ?> 
             ...
             <td><?php echo $i ?></td>
                ...
                <td style="display:flex"><a class="aa"href="viewComplain.php?id=<?php echo $cid ?>"><i class="fa-solid fa-eye"></i></a>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="aa"href="deleteComplain.php?id=<?php echo $cid ?>"><i class="fa-solid fa-trash icon"></i></a></td>
            </tr>
            <?php
        }
    }
