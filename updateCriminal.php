...
?>
 <?php
    if(isset($_POST['submit'])){
        ...
        $photo=$_POST['photo'];
        $sql="UPDATE criminal set crimetype='$crimetype',crimedate='$crimedate',crimetime='$crimetime'
        ,name='$name', moblienum='$mobilenum',height='$height',weight='$weight',dob='$dob',email='$email',
        city='$city',country='$country',photo='$photo' where cid='$id'";
        $result=mysqli_query($con,$sql);
    }
    ?>
<!DOCTYPE html>
          ...
          <div class="second-list">
            <fieldset class="crimefield">
              ...
              <form class="addcriminal" action="<?php $s ?>" method="POST">
                ...
                <select name="crimetype" required value="<?php echo $Rr['crimetype']?>">
            ...
            <legend class="l2"><h1>Criminal Details</h1></legend>             
                ...
                <label>Height:</label>
                <input type="text" name="height" style="width: 15%" value="<?php echo $Rr['height']?>" />
                ...
                >
                <input type="email" name="email" style="width: 15%" value="<?php echo $Rr['email']?>"/>
                <br /><br />
                <label style="font-size:18px ;color:rgb(48, 154, 160);">Address Info:</label><br /><br />
                <label>City:</label>
                <input type="text" name="city" style="width: 15%" value="<?php echo $Rr['city']?>"/>
                <label style="margin-left: 285px">Country:</label>
                <input type="text" name="country" style="width: 15%" value="<?php echo $Rr['country']?>"/>
                <br /><br />
                <label>Photo:</label>
